...
def satisfiable(constraints, symbolic_input, concrete_input, bof_func):
	...
	if bof_func=="gets":
		...
		constraints += [symbolic_input==input_bvv]
		satisfiable = solver.satisfiable(extra_constraints=constraints)
